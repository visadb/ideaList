...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Subscription', fields ['list', 'user']
        db.create_unique('ideaList_subscription', ['list_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Subscription', fields ['list', 'user']
        db.delete_unique('ideaList_subscription', ['list_id', 'user_id'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.priority'
        db.delete_column('ideaList_item', 'priority')

        # Adding field 'Item.important'
        db.add_column('ideaList_item', 'important', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Item.priority'
        db.add_column('ideaList_item', 'priority', self.gf('django.db.models.fields.CharField')(default=u'NO', max_length=2), keep_default=False)

        # Deleting field 'Item.important'
        db.delete_column('ideaList_item', 'important')

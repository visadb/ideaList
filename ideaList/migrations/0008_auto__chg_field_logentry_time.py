...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogEntry.time'
        db.alter_column('ideaList_logentry', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'LogEntry.time'
        db.alter_column('ideaList_logentry', 'time', self.gf('django.db.models.fields.DateTimeField')())

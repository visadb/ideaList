...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ItemFrequency'
        db.create_table('ideaList_itemfrequency', (
        ...
        db.send_create_signal('ideaList', ['ItemFrequency'])


    def backwards(self, orm):
        
        # Deleting model 'ItemFrequency'
        db.delete_table('ideaList_itemfrequency')

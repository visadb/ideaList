...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subscription.minimized'
        db.delete_column('ideaList_subscription', 'minimized')


    def backwards(self, orm):
        
        # Adding field 'Subscription.minimized'
        db.add_column('ideaList_subscription', 'minimized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

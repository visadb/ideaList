...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'List.trashed_at'
        db.add_column('ideaList_list', 'trashed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'List.trashed_at'
        db.delete_column('ideaList_list', 'trashed_at')

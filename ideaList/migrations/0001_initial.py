...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'List'
        db.create_table('ideaList_list', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lists_owned', to=orm['auth.User'])),
        ))
        db.send_create_signal('ideaList', ['List'])

        # Adding model 'Item'
        db.create_table('ideaList_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['ideaList.List'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True)),
            ('priority', self.gf('django.db.models.fields.CharField')(default=u'NO', max_length=2)),
            ('last_changed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('ideaList', ['Item'])

        # Adding model 'Subscription'
        db.create_table('ideaList_subscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['auth.User'])),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['ideaList.List'])),
            ('minimized', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('ideaList', ['Subscription'])


    def backwards(self, orm):
        
        # Deleting model 'List'
        db.delete_table('ideaList_list')

        # Deleting model 'Item'
        db.delete_table('ideaList_item')

        # Deleting model 'Subscription'
        db.delete_table('ideaList_subscription')
    ...
    models = {
        ...
        'ideaList.subscription': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Subscription'},
            '_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.trashed_at'
        db.add_column('ideaList_item', 'trashed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.trashed_at'
        db.delete_column('ideaList_item', 'trashed_at')
    ...
    models = {
        ...
        'ideaList.subscription': {
            'Meta': {'ordering': "['position']", 'object_name': 'Subscription'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
